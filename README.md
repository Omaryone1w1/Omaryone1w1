...
```mermaid
flowchart LR
    A[AI Engineering] --> B[Computer Vision]
    A --> C[Deep Learning: CNN / RNN / ANN]
    A --> D[Model Optimization]
    E[Embedded Systems] --> F[Arduino & IoT]
    E --> G[Real-time Sensor Systems]
    B --> H[Production-Ready Solutions]
    C --> H
    D --> H
    F --> H
    G --> H
...
<picture>
  ...
  <img alt="snake animation" src="https://raw.githubusercontent.com/Omaryone1w1/Omaryone1w1/output/github-contribution-grid-snake.svg" />
</picture>
</div>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1a0b2e,50:6a1b1b,100:ff6b35&height=120&section=footer&text=Thanks%20for%20visiting!&fontSize=26&fontColor=ffffff&fontAlignY=75&animation=fadeIn" width="100%"/>
